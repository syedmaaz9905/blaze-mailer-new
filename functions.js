function shareData() {
    ...
    const subject = document.getElementById('subjectFieldContent1').value;
    const name = document.getElementById('nameFieldContent1').value;
    ...
    // Use window.api.invoke to send data to the main process for 'shareData'
    window.api.invoke('shareData', data)
        .then(function (res) {
